...
public class ChangeShader_Bone : MonoBehaviour
{
    ...
    //BoneMaterial
    public Material BoneShader_Transparent0;
    public Material BoneShader_Transparent50;
    public Material BoneShader_Transparent100;
    ...
    public void SetTransparentMaterial()
    {
        if (ButtonCount % 3 == 0)
        {
            GetComponent<MeshRenderer>().material = BoneShader_Transparent0;
        }
        else if (ButtonCount % 3 == 1)
        {
            GetComponent<MeshRenderer>().material = BoneShader_Transparent50;
        }
        else if (ButtonCount % 3 == 2)
        {
            GetComponent<MeshRenderer>().material = BoneShader_Transparent100;
        }
